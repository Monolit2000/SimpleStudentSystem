...
public class StudentsController : Controller
{
    ...
    public async Task<IActionResult> Index(string? culture)
    {
        ...
        try
        {
            var model =  await _databaseService.GetOllStudentsAsync();
    ...
    public async Task<IActionResult> Create(int id, string name, int age, string major, int[] subjectIdDst)
    {
        ...
        try
        {
            ...
            {
                var additionResult = await _databaseService.CreateStudentAsync(id, name, age, major, subjectIdDst);
    ...
    public async Task<IActionResult> Edit(int? id)
    {
        ...
        try
        {
            if (id != null)
            {
                var student = await _databaseService.GetStudentWithSubjectsAsync(id);
                if (student != null)
                {
                    result = View(student);
                }
    ...
    public async Task<IActionResult> Edit(int id, string name, int age, string major, int[] subjectIdDst)
    {
        ...
        catch (Exception ex)
        {
            ...
            _logger.LogError("Exception caught: " + ex.Message);
            var student = await _databaseService.GetStudentAsync(id);
            result = View(student);
        }
    ...
    public async Task<IActionResult> DeleteConfirmed(int id)
    {
        ...
        try
        {
            await _databaseService.DeleteStudentAsync(id);
    ...
    {
        var result = _databaseService.StudentExists(id);
        return result;
    }
